# LangGraph JavaScript 示例

基于 LangGraph JavaScript 的 Agent 示例项目，可部署至腾讯云 CloudBase 作为 HTTP 云函数运行。

> 📚 **参考文档**：[CloudBase AI Agent 开发指南](https://docs.cloudbase.net/ai/agent-development/)

## 功能概述

本项目创建了一个基于 LangGraph 的 AI 对话代理服务，具备以下特性：
...
| [@cloudbase/agent-adapter-langgraph](https://www.npmjs.com/package/@cloudbase/agent-adapter-langgraph) | LangGraph 适配器，将 LangGraph 工作流转换为 AG-UI 格式 |
| [@langchain/openai](https://www.npmjs.com/package/@langchain/openai) | LangChain OpenAI 集成 |
| [@langchain/langgraph](https://www.npmjs.com/package/@langchain/langgraph) | LangGraph 状态图与工作流管理 |
| [@langchain/core](https://www.npmjs.com/package/@langchain/core) | LangChain 核心库 |
...
修改 `src/agent.js` 中的 `systemMessage` 可自定义 Agent 角色：
